...
const SERVICES = [
  ...
  { icon: "▶", title: "تصميم فيديوهات", desc: "موشن جرافيك وإعلانات مرئية تشد الانتباه وتحكي قصة علامتك", color: "#F5E6C8" },
];

export default function Home() {
  useSEO({
    title: "وكالة تصميم جرافيك احترافية | Shadj Graphics",
    description: "شدج — وكالة تصميم جرافيك احترافية في مصر والسعودية. متخصصة في الهوية البصرية، البوسترات، السوشيال ميديا، وتصميم الفيديوهات. +46 مشروع ناجح.",
      ...
      <section className="py-32 relative overflow-hidden" style={{background:"linear-gradient(135deg, #0f0e1a 0%, #1e1b4b 40%, #3730A3 100%)"}}>
        ...
        <div className="container mx-auto px-6 relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="/order"
              className="inline-block bg-[#F5E6C8]/20 border border-[#F5E6C8]/30 text-[#F5E6C8] px-10 py-4 rounded-full font-bold hover:bg-[#F5E6C8] hover:text-[#1a1a2e] transition-all">
              ابدأ مشروعك الآن
            </a>
          </div>
        </div>
        ...
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="space-y-3">
            {[
              ...
              { q: "ما هي أوقات العمل؟", a: "شَـــدِج متاحة لاستقبال مشاريعك 24 ساعة عبر النموذج الإلكتروني، وفريقنا يرد خلال 24 ساعة." },
            ].map((faq, i) => (
